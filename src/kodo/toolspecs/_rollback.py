...
ROLLBACK: ToolSpec = ToolSpec(
    ...
    description=(
        ...
        "Moves one bound project's checkpoint mirror back to the target commit, restoring "
    ...
    input_schema={
        ...
        "properties": {
            ...
            "root": {
                "type": "string",
                "description": ("Which bound project to roll back — a name from get_root_paths."),
            },
            "target_sha": {
                "type": "string",
        ...
        "required": ["intent", "root", "target_sha"],
    },
    output_schema={
        "type": "object",
        "properties": {
