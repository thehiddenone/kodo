...
_HARDCODED_LOCAL_MODELS: tuple[LocalLLMEntry, ...] = (
    ...
    LocalLLMEntry(
        name="llamacpp-gpt-oss-120b-f16",
        kind="hardcoded_hf",
    ...
    LocalLLMEntry(
        name="llamacpp-gpt-oss-20b-q8-k-xl",
        kind="hardcoded_hf",
    ...
    LocalLLMEntry(
        name="llamacpp-gpt-oss-20b-q8-0",
        kind="hardcoded_hf",
    ...
    LocalLLMEntry(
        name="llamacpp-gpt-oss-20b-q6-k-xl",
        kind="hardcoded_hf",
    ...
    LocalLLMEntry(
        name="llamacpp-gpt-oss-20b-q4-k-xl",
        kind="hardcoded_hf",
    ...
    LocalLLMEntry(
        name="llamacpp-ornith10-35b-bf16",
        kind="hardcoded_hf",
