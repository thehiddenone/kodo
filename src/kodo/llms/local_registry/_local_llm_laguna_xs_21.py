...
def laguna_xs_21_entries() -> list[LocalLLMEntry]:
    return [
        ...
        LocalLLMEntry(
            ...
            "to a 32GB DDR5 kit.",
            mac_tip="Needs ~36GB — fits a 48GB MacBook Pro comfortably; a 36GB MacBook Pro is "
            "tight.",
            min_memory=36,
            memory=48,
            llamacpp_version=10087,
        ...
        LocalLLMEntry(
            ...
            mac_tip="Needs ~28GB — fits a 32GB MacBook Pro comfortably.",
            min_memory=32,
            memory=32,
            llamacpp_version=10087,
        ),
        ...
        LocalLLMEntry(
            ...
            mac_tip="Needs ~19GB — fits a 24GB MacBook Pro comfortably.",
            min_memory=24,
            memory=24,
            llamacpp_version=10087,
        ),
