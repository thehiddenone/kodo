...
#: Every entry in this family offers the shared knobs, the MoE Qwen YaRN
#: context knob, and the MTP knob.
_QWEN36_35B_KNOBS = SHARED_KNOBS + (QWEN_MOE_CONTEXT_KNOB, MTP_SPEC_DECODE_KNOB)
