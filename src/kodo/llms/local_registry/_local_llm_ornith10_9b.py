...
def ornith10_9b_entries() -> list[LocalLLMEntry]:
    return [
        LocalLLMEntry(
            name="ornith-ai-ornith10-9b-bf16",
            kind="hardcoded_hf",
            description="Ornith 1.0 9B BF16 by Ornith AI",
            repo_id="ornith-ai/Ornith-1.0-9B-GGUF",
        ...
        LocalLLMEntry(
            name="ornith-ai-ornith10-9b-q8-0",
            kind="hardcoded_hf",
            description="Ornith 1.0 9B Q8_0 by Ornith AI",
            repo_id="ornith-ai/Ornith-1.0-9B-GGUF",
        ...
        LocalLLMEntry(
            name="ornith-ai-ornith10-9b-q6-k",
            kind="hardcoded_hf",
            description="Ornith 1.0 9B Q6_K by Ornith AI",
            repo_id="ornith-ai/Ornith-1.0-9B-GGUF",
        ...
        LocalLLMEntry(
            name="ornith-ai-ornith10-9b-q5-k-m",
            kind="hardcoded_hf",
            description="Ornith 1.0 9B Q5_K_M by Ornith AI",
            repo_id="ornith-ai/Ornith-1.0-9B-GGUF",
        ...
        LocalLLMEntry(
            name="ornith-ai-ornith10-9b-q4-k-m",
            kind="hardcoded_hf",
            description="Ornith 1.0 9B Q4_K_M by Ornith AI",
            repo_id="ornith-ai/Ornith-1.0-9B-GGUF",
