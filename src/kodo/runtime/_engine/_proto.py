...
class EngineHost(Protocol):
    ...
    def _current_base_llm(self) -> str: ...

    def _thinking_kwargs(self, routing: LLMRouting) -> dict[str, object]: ...

    def _thinking_level_for_model(self, base_llm: str, prefer: str | None) -> str: ...
    ...
    def _plan_dir(self) -> Path | None: ...

    def _is_planner(self, name: str) -> bool: ...

    async def _initialize_plan(self, name: str, output: dict[str, object]) -> None: ...
