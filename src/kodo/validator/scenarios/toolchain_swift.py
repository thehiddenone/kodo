"""Scenario: CLI Fibonacci number calculator, with tests + toolchain, in Swift.
...
spawns ``toolchain_builder`` for Swift. This file is content-only (see
