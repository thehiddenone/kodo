...
You have a persistent key-value scratch space that survives across your calls (and across separate `kodo_web_search` runs, for up to 12 hours per entry). Use it for two things:
