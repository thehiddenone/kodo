...
**The compaction contract.** The compactor produces a **condensed transcript**, not a briefing — the same conversation, same turns, same order, fewer words. The rules it works to (`subagent_compactor.md`) are:
