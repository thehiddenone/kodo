"""Behavior tests for kodo.llms.meta._convert.

Meta's Model API is Responses-API-shaped (same as OpenAI's), so this mirrors
test_openai_convert.py's shape/cases exactly against the Meta plugin's own
(deliberately separate, not shared) copy of the conversion logic.
"""
...
from kodo.llms.meta._convert import build_input_items, build_tool_defs
