"""Behavior tests for kodo.llms.openai._retry.

Mirrors test_retry.py (the Anthropic plugin's equivalent) with real `openai`
SDK exception instances, since both SDKs are Stainless-generated with
matching exception shapes and both wire into the same shared
kodo.llms._provider_retry core.
"""
...
from kodo.llms.openai._retry import (
    RetryExhaustedError,
    UnrecoverableError,
    with_retry,
    with_retry_iter,
...
# ---------------------------------------------------------------------------
# Helpers: build OpenAI error instances with minimal valid arguments
# ---------------------------------------------------------------------------
...
# depends on this being the SAME class object as Anthropic's.
# ---------------------------------------------------------------------------
